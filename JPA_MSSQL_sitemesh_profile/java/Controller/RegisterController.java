...
public class RegisterController extends HttpServlet {
	public static final String REGISTER = "views/general/register.jsp";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (ss != null) {
			...
			if (uname == "admin") {
				resp.sendRedirect("views/admin");
				return;
			} else if (uname == "manager") {
				resp.sendRedirect("views/manager");
				return;
			} else {
				resp.sendRedirect("views/user");
				return;
			}
		}
		...
		if (cookies != null) {
			for (Cookie cookie : cookies) {
				if (cookie.getName().equals("username")) {
					...
					ss.setAttribute("username", cookie.getValue());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (service.checkExistUsern(username)) {
