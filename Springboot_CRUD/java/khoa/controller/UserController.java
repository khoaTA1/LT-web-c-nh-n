...
public class UserController {
	...
	public String register(ModelMap model, @RequestParam(name = "username", required = true) String uname,
		...
		if (userserv.existsByUserName(uname)) {
			model.addAttribute("msg", "Tên đăng nhập đã tồn tại!");
			return "general/register";
		}

		User checkSavedUser = userserv.save(user);
